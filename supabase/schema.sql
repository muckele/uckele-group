...
revoke all privileges on function public.insert_current_deal_hunter_opportunity_fact(text, text, text, text, text, boolean, text, text, timestamptz, timestamptz) from public, anon, authenticated;
grant execute on function public.insert_current_deal_hunter_opportunity_fact(text, text, text, text, text, boolean, text, text, timestamptz, timestamptz) to service_role;
