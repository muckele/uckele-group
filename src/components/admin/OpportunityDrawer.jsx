        ...
        <div className="space-y-5 p-4 sm:p-5">
          ...
          {detail ? <>
            ...
            <Section title="Score & Evidence">
              <div className="grid gap-3 sm:grid-cols-2"><div className="rounded-xl bg-moss/8 p-3"><h4 className="text-sm font-semibold text-moss">Strengths</h4>{detail.score.summary?.strengths?.map((item) => <p className="mt-1 text-sm text-ink/70" key={item}>{item}</p>)}</div><div className="rounded-xl bg-amber-50 p-3"><h4 className="text-sm font-semibold text-amber-900">Concerns</h4>{detail.score.summary?.concerns?.map((item) => <p className="mt-1 text-sm text-ink/70" key={item}>{item}</p>)}</div></div>
