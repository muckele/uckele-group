...
import CimStage2ReviewQueue from './CimStage2ReviewQueue';
...
export default function OperationsCenter({
  ...
  cimStage2Updating = false, onStage2EvidenceRecorded, readOnly = false,
}) {
  ...
  return (
    <div className="space-y-6" data-admin-tour="operations-readiness">
      ...
      <section className="panel p-5 sm:p-7" aria-labelledby="cim-automation-heading">
        ...
        {!readOnly ? <CimStage2ReviewQueue onEvidenceRecorded={onStage2EvidenceRecorded} /> : null}
